...
> Im folgenden Lernbaustein soll versucht werden, einen Überblick über den Themenkomplex KI und die sich daraus ergebenden Möglichkeiten und Risiken zu geben. 
> Damit soll eine Basis für die sogenannte **AI-Literacy** gelegt werden.

---

<h3>Was erwartet dich in diesem Lernbaustein?</h3>

1. [**Begrifflichkeiten:**](#ai-ki-was-ist-das-überhaupt) _AI, KI... Was ist das überhaupt?_
    
2. [**Anwendung:**](#wie-kann-ich-ki-für-mich-nutzen) _Wie kann ich KI für mich nutzen?_
    
3. [**Risiken und Empfehlungen:**](#alles-so-einfach) _Alles so einfach?_
    
4. [**Weiterführende Ressourcen**](#weiterführende-ressourcen)
...
> Im folgenden Abschnitt sollen zunächst Begrifflichkeiten aus dem Bereich der künstlichen Intelligenz erläutert werden, anschließend die Funktionsweise einer KI an einem einfachen Beispiel veranschaulicht werden und schließlich das neu erworbene Wissen in einem kleinen Quiz abgefragt werden.

![Buchstaben](Bilder/TiBi_cubes_04-02-23.png)

### Begriffserläuterungen

Hier eine kleine Auswahl an Begrifflichkeiten:

* **Künstliche Intelligenz/Artificial Intelligence (KI/AI)**: "Intelligente" Maschinen, die menschenähnliche Aufgaben ausführen können, wie zB. Entscheidungen treffen, Probleme lösen und Sprache erkennen. Im Gegensatz zu herkömmlichen Systemen kann eine künstliche Intelligenz Aufgaben autonom ausführen.
...
![PC und Äpfel](Bilder/Abb_apple1_02-02-23.JPG)
...
Der Computer kann jetzt in neuen und unbekannten Bildern Äpfel erkennen. Das ist dann die **Computer Vision**.

![PC und Äpfel](Bilder/Abb_apple2_02-02-23.JPG)
...
> Im folgenden Abschnitt sollen Anwendungsfelder von KI in der Forschung vorgestellt werden und anhand der Software ChatGPT auch ein konkretes Anwendungsbeispiel gezeigt werden.
...
* **Computer Vision**: In der Medizin automatische Erkennung von Krankheiten wie Krebs mittels bildgebender Verfahren wie MRT.
* Automatisierte **Auslesung** von Handschriften in der Geschichtswissenschaft.
* **Natural Language Processing**: Suchmaschinen wie etwa Google.
* Automatisierte **Übersetzungen** durch Übersetzungsprogramme.  
...
> ChatGPT (Generative Pre-trained Transformer) ist ein KI-Sprachmodell der Firma OpenAI, welches natürliche Sprache verstehen und generieren kann. Es ist damit ein Beispiel für Natural Language Processing. Trainiert wurde es durch über 500 Milliarden Wörter aus Texten aus dem Internet. Zum Zeitpunkt der Erstellung des Lernbausteins (Januar 2023) ist das Programm komplett kostenlos, es wurde jedoch bereits angekündigt, dass es bald eine kostenpflichtige Pro-Version geben soll.
    
***Wofür kann ich ChatGPT nutzen?***
    
Um diese Frage zu beantworten, werden wir im Folgenden ein paar Tests mit ChatGPT durchführen. Du kannst dich entweder selbst anmelden und das Programm befragen oder du guckst dir einfach die folgenden Screenshots an, auf denen das Programm auf verschiedene Eingaben antwortet. (Die Fragen wurden an ChatGPT Jan 30 Version gestellt.)
...
![Antwort](Bilder/Abb_GPT4b_04-02-23.png)
...
> Hier ist ganz klar ersichtlich, dass die Software noch nicht so weit ist, ganze wissenschaftliche Aufsätze zu schreiben. Inhaltlich bleibt alles sehr vage und es wurden zwar Literaturverweise auf real existierende Literatur angegeben, jedoch scheinen diese eher willkürlich eingefügt. Bei erneuter Befragung gibt das Programm auch selbst den Hinweis:
> ![Hinweis](Bilder/Abb_GPT8b_04-02-23.png)
...
Für folgende Aufgaben ist die Software ChatGPT also gut bzw. schlecht geeignet:
